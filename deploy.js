...
const versionSql =
  "CREATE TABLE IF NOT EXISTS versions (id INTEGER PRIMARY KEY CHECK (id = 1), sys TEXT NOT NULL DEFAULT '1', ui TEXT NOT NULL DEFAULT '1');" +
  "INSERT OR IGNORE INTO versions (id, sys, ui) VALUES (1, '1', '1');" +
  `UPDATE versions SET sys='${VERSION}' WHERE id=1;`;
run("npx", [
  "wrangler", "d1", "execute", cfg.cloudflare.d1Name,
  "--command", versionSql,
  "--remote",
]);
