...
export async function onRequest(ctx) {
  ...
  const overall = allOk ? { t: "All systems operational", c: "#3fb96a", e: "✅" } : components[0].ok && components[1].ok ? { t: "Partial degradation", c: "#e0a93f", e: "⚠️" } : { t: "Service disruption", c: "#e0556a", e: "🔴" };
  const esc = (s) => String(s == null ? "" : s).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
  const now = /* @__PURE__ */ (/* @__PURE__ */ new Date()).toUTCString();
