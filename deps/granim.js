    ...
    2: [
      function (t, e, i) {
        ...
        e.exports = function (t) {
          ...
          ((null === this.previousTimeStamp || o) && (this.previousTimeStamp = t),
            (this.progress = this.progress + (t - this.previousTimeStamp)),
            (e = ((this.progress / this.activetransitionSpeed) * 100).toFixed(2)),
      ...
      function (t, e, i) {
        ...
        e.exports = function (t) {
          return "removeListeners" === t
            ? void window.removeEventListener("resize", this.setSizeAttributesNameSpace)
            : void window.addEventListener("resize", this.setSizeAttributesNameSpace);
        };
      },
      {},
    ],
          ...
          (this.scrollDebounceTimeout && clearTimeout(this.scrollDebounceTimeout),
            (this.scrollDebounceTimeout = setTimeout(function () {
              ...
              if (
                ...
                (!t.image &&
                  t.firstScrollInit &&
                  (t.refreshColorsAndPos(), (t.firstScrollInit = !1)),
                  t.isPaused ||
                    t.isPausedBecauseNotInView ||
                    ((t.isPausedBecauseNotInView = !0), t.pause("isPausedBecauseNotInView")));
          ...
          function t() {
            function t(t) {
              ...
              if (e.image.stretchMode)
                switch ((n = "x" === t ? e.image.stretchMode[0] : e.image.stretchMode[1])) {
                  case "none":
                    break;
                  case "stretch":
                    ((e.imagePosition[t] = 0),
                ...
                (this.imageNode.onload = function () {
                  ((e.imgOriginalWidth = e.imageNode.width),
                    ...
                    (e.isPausedWhenNotInView && !e.isCanvasInWindowView) ||
                      (e.animation = requestAnimationFrame(e.animateColors.bind(e))),
                    (e.isImgLoaded = !0));
                }),
            ...
            for (o = 0; o < 4; o++)
              ((e =
                ...
                (3 !== o
                  ...
                  : Math.round((n.activeColorsDiff[s][o] / 100) * t * 100) / 100)),
                e <= 255 && e >= 0 && (n.currentColors[s][o] = e));
            ((i = parseFloat(
              (n.activeColorsPos[s] + (n.activeColorsPosDiff[s] / 100) * t).toFixed(4)
            )),
                  ...
                  function (n, r) {
                    ...
                    (c[o.channelsIndex].colors.push(h),
                      ...
                      o.isCurrentColorsSet ||
                        (o.currentColors.push(o.convertColorToRgba(n)), o.currentColorsPos.push(a)),
                      o.channelsIndex === o.states[o.activeState].gradients.length - 1
                        ? ((t = o.getColorDiff(c[o.channelsIndex].colors[r], c[0].colors[r])),
                          (e = o.getColorPosDiff(
                            c[o.channelsIndex].colorsPos[r],
                            c[0].colorsPos[r]
                          )))
                        : ((i = o.convertColorToRgba(
                            o.getColor(o.states[o.activeState].gradients[o.channelsIndex + 1][r])
                          )),
                          (s = o.getColorPos(
                            o.states[o.activeState].gradients[o.channelsIndex + 1][r],
                            r
                          )),
                          (t = o.getColorDiff(c[o.channelsIndex].colors[r], i)),
                          (e = o.getColorPosDiff(c[o.channelsIndex].colorsPos[r], s))),
