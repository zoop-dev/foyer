!(function () {
  ...
  function J(e, t, r) {
    for (var n, o = e.__k, i = 0; o && i < o.length; i++)
      (n = o[i]) &&
        ((n.__ = e), (t = "function" == typeof n.type ? J(n, t, r) : Q(r, n, n, o, n.__e, t)));
    return t;
  }
  function Z(e, t) {
    return (
  ...
  function oe(e, t, r, n, o, i, a, s, c) {
    ...
    (null != r.__h && ((c = r.__h), (s = t.__e = r.__e), (t.__h = null), (i = [s])),
      (l = R.__b) && l(t));
    try {
  ...
  function Ge(e) {
    ...
    /*FOYER-PATCH:render /assets/icons/*.svg as themeable mask spans not <img>*/ if (
      a &&
      a.indexOf("/assets/icons/") >= 0
    ) {
      var __fm = "url(" + a + ") center/contain no-repeat";
      return de("span", {
        ...
        children: de("span", {
          style:
            ...
            ";height:" +
            (e.size || "1em") +
            ";background:currentColor;-webkit-mask:" +
            __fm +
            ";mask:" +
            __fm +
      ...
      function o(e) {
        ...
        (a(this, o),
          l(n((s = r.call(this))), "darkMediaCallback", function () {
            "auto" == s.props.theme &&
              s.setState({ theme: s.darkMedia.matches ? "dark" : "light" });
          }),
      ...
      return (
        c(o, [
          ...
          },
          {
            ...
            value: function () {
              if (
                (this.register(), (this.shadowRoot = this.base.parentNode), this.props.autoFocus)
              ) {
          ...
          },
          {
            ...
            value: function () {
              var e =
                "none" == this.props.previewPosition || "search" == this.props.skinTonePosition;
              return de("div", {
                children: [
                  de("div", { class: "spacer" }),
                  de("div", {
