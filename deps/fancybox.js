!(function (t, e) {
  ...
  class D extends m {
      ...
      if (
        ...
        if (this.option("spinner")) {
          ...
          !t.contains(o) || o.parentElement instanceof HTMLPictureElement
            ...
            : (this.spinner =
                (null === (n = o.parentElement) || void 0 === n ? void 0 : n.insertBefore(e, o)) ||
                null);
        }
    ...
    destroy() {
      ...
      (e &&
        (e.removeEventListener("load", this.onLoad), e.removeEventListener("error", this.onError)),
        this.detachPlugins());
    }
  }
  ...
  class U extends $ {
    ...
    onTargetChange() {
      ...
      const s =
          null === (e = null === (t = i.pages[i.page]) || void 0 === t ? void 0 : t.slides[0]) ||
          void 0 === e
            ? void 0
            : e.index,
  ...
  class tt extends m {
    ...
    processOptions() {
      ...
      (n === this.bp && this.state !== H.Init) ||
        ...
        this.state === H.Ready &&
          (i.initialSlide =
            (null ===
              (e = null === (t = this.pages[this.page]) || void 0 === t ? void 0 : t.slides[0]) ||
            void 0 === e
              ? void 0
              : e.index) || 0),
    ...
    initLayout() {
      ...
      (n ||
        ((n = document.createElement("div")), C(n, e.track), n.append(...Array.from(i.childNodes))),
    ...
    onDecel(t, e = 0, i = 0, n = 0, s = 0) {
      ...
      (Math.abs(d) > 5
        ? (l[u].dim <
            document.documentElement["client" + (this.isHorizontal ? "Width" : "Height")] - 1 &&
            (u = g),
    ...
    getVisibleSlides(t = 0) {
      ...
      if (o) {
        s =
          s +
            (null === (e = this.slides[this.slides.length - 1]) || void 0 === e ? void 0 : e.gap) ||
          0;
        let l = 0;
        ((l =
          ...
          p({ transformParent: !0 }, this.option("Panzoom") || {}, {
            ...
            click: (e, i) => {
              ...
              let o =
                !i ||
                (i.target &&
                  (null === (s = t.contentEl) || void 0 === s ? void 0 : s.contains(i.target)));
          ...
          on: {
            ...
            resume: (e, i) => {
              ...
              !i ||
                !i.cancelable ||
                ((null === (n = t.getSlide()) || void 0 === n ? void 0 : n.state) === ct.Ready &&
                  (null === (o = null === (s = t.carousel) || void 0 === s ? void 0 : s.panzoom) ||
                  void 0 === o
                    ? void 0
                    : o.isResting)) ||
                i.preventDefault();
  ...
  class Vt extends $ {
    ...
    onCreateSlide(t, e) {
      ...
      const o =
          (null ===
            (s =
              null === (n = null === (i = this.instance) || void 0 === i ? void 0 : i.carousel) ||
              void 0 === n
                ? void 0
  ...
  class Ae extends m {
          ...
          (s.on("Panzoom.afterTransform", (t, e) => {
            ...
            if (s) {
              const t = Math.abs(e.current.f),
                i =
                  t < 1 ? "" : Math.max(0.5, Math.min(1, 1 - (t / e.contentRect.fitHeight) * 1.5));
    ...
    detachEvents() {
      ...
      const i = window.visualViewport;
      (i &&
        (i.removeEventListener("resize", t.onResize), i.removeEventListener("scroll", t.onResize)),
        document.removeEventListener("visibilitychange", t.onVisibilityChange, !1),
    ...
    focus(t) {
      ...
      (t
        ? (!n || c.indexOf(n) < 0) &&
          ((d = h || s),
          c.length &&
            (i === Ee ? (d = c[0]) : (this.lastFocus !== s && i !== xe) || (d = c[c.length - 1])))
    ...
    revealContent(t, e) {
      ...
      this.isClosing() ||
        ...
        this.isOpeningSlide(t) &&
          (P(this.container, de), !this.isCompact && this.option("idle") && this.setIdle()));
    }
    isCurrentSlide(t) {
    ...
    static fromSelector(t, e, i) {
      ...
      return (
        !!a &&
        ((o = p({}, a.get(s) || {}, o)), !!o && Ae.fromNodes(Array.from(n.querySelectorAll(s)), o))
      );
    }
