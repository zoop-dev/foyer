import { SESSION_KEY, VERSION, dismissLoading } from "./10-core.js";
import { showAuthWall } from "./60-gate.js";
...
export function showUpdateOverlay(pendingUiVersion, newVer) {
...
export async function protectedFetch(url, session) {
