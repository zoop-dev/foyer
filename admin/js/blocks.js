...
function bE(s)   { return foyerIconText(String(s||'').replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/>/g,'&gt;')); }
...
const BLOCK_CATALOG = [
  ...
  { t:'colllist', l:'Collection list', c:'Cards & grids', i:'@layers', k:'collection blog articles entries list embed posts' },
  ...
  { t:'buttongroup', l:'Button group', c:'Lists & links', i:'mouse-pointer', k:'cta row buttons' },
  { t:'toc', l:'Table of contents', c:'Lists & links', i:'compass', k:'jump menu anchors nav' },
  ...
  { t:'testimonials', l:'Testimonials', c:'Conversion', i:'@chat', k:'quotes reviews social proof' },
  ...
  { t:'availability', l:'Availability', c:'People & contact', i:'@check-circle', k:'open to work status' },
  ...
  { t:'resume', l:'Resume timeline', c:'Portfolio', i:'file-text', k:'experience education cv' },
  { t:'qrcode', l:'QR code', c:'Portfolio', i:'qr', k:'qr link' },

  { t:'faq', l:'FAQ', c:'Interactive', i:'help', k:'faq questions answers accordion frequently asked' },
