...
function bDefault(type) {
  ...
  switch(type) {
    ...
    case 'collection': return { id, type, heading:'My Collection', show_count:'yes', layout:'grid-3', items:[{imgs:[''],name:'Item one',note:'',for_sale:'no',price:'',buy:'no',buy_label:'Buy',buy_url:''},{imgs:[''],name:'Item two',note:'',for_sale:'no',price:'',buy:'no',buy_label:'Buy',buy_url:''}], pad:'md' };
